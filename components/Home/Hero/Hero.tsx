      ...
      <div className="flex justify-center flex-col w-4/5 h-full mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
          ...
          <div>
            ...
            {/* Button */}
            <button className="text-white font-semibold md:px-8 md:py-2.5 px-6 py-1.5 text-sm md:text-lg transition-all duration-200 rounded-lg bg-blue-700 mt-8 hover:bg-blue-900 flex items-center space-x-2">
              <span>Resume</span>
              <FaDownload />
            </button>
          </div>
